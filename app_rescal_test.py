...
def initiate_data():
    ...
    return tensor_vis, bar_index, bar_value, entities, relations, GROUND_TRUTH, distribution_0_visualize, last, re_Ground_truth, entity_embedding
...
def generate_data(cluster):
    ...
    # 12
    re_tensor, entities_test, last, re_Ground_truth, re_tensor_ori = entity_cluster_tensor(cluster,entity_embedding, tensor_vis, entities, GROUND_TRUTH, tensor)

    return tensor_vis, bar_index, bar_value, entities, relations, GROUND_TRUTH, distribution_0_visualize, last, re_Ground_truth, entity_embedding, re_tensor_ori
